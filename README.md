...
>**Разница между node и npm**. **node** - просто для запуска кода js. **npm** - установка библиотек, запуск проектов. **npx** - для запуска библиотек отдельно 
...
>Все эти типы не попадут в JavaScript после транспиляции, не переживайте о производительности на этот счет
